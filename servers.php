                            ...
                            <div class="data">
                               <div class="status">
                                 ...
                                 <ul>
                                   ...
                                   <li class="name"><a href="post?server=<?php echo $server['id'];?>" target="_blank"><?php echo strtoupper($server['name']); ?></a></li>
                                 </ul>
                               </div>
                             <div class="server-img">
                                 <a href="post?server=<?php echo $server['id'];?>" target="_blank">
